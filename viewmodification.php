...
<div class="container-fluid">
  ...
  <div class="card mb-3">
    <div class="card-header">
      ...
      <?php echo 'Departement : '. htmlspecialchars($departement->nom) . " Code : ".  htmlspecialchars($departement->code);    ?></div>
    <div class="card-body">
      ...
      <table class="table table-bordered "  id="dataTable1" width="100%" cellspacing="0">
              ...
              $array=preparaTableDep($dbname,  $collname_m, $manager,[], $options);          
